...
- `approved_software.json`: mock software approval, OS support, licensing, and install guidance.
- `ticket_status.json`: mock helpdesk queue statuses for exact-ID lookup.
